...
@Component({
  selector: 'app-mute-user-page',
  templateUrl: './mute-user-page.component.html'
})
export class MuteUserPageComponent implements OnInit {
  user: User;
  ...
  mute() {
    ...
    this.apiService
      ...
      .subscribe({
        ...
        error: (e) => {
          this.isFound = true;
          this.error = "You don't have permission to mute this user!";
        }
      });
  }
